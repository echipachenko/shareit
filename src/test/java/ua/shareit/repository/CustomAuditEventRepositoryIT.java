...
import ua.shareit.config.audit.AuditEventConverter;
import ua.shareit.domain.PersistentAuditEvent;
...
import static ua.shareit.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
